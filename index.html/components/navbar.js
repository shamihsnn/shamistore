const navbar = () => {
    ...
    <div id="top-left">
        <div id="logo">
            <img src="img/med.jpeg" alt="logo">
        </div>
        <div id="content">
            <div id="meds">shamimedstore</div>
            <div id="lab-tests">
            ...
            <div id="ayurveda">homeopathy</div>
            <div id="care-plan">
...
<div id="nav-bottom">
    ...
    <div id="ayurved"  class="dropdown">
        <div class="ddmenu">HOMEOPATHY Products <i class="arrow down"></i></div>
        <div id="ayvd" class="dropdown-content">
            <a href="allProducts.html">HOMEOPATHY Top Brands</a>
            <a href="allProducts.html">HOMEOPATHY</a>
